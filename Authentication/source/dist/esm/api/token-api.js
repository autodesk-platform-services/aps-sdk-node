...
export const TokenApiAxiosParamCreator = function (apsConfiguration) {
    return {
         ...
         */
        authorize: (/* accessToken: string, */ clientId, responseType, redirectUri, state, nonce, scope, responseMode, prompt, authoptions, codeChallenge, codeChallengeMethod, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        fetchtoken: (/* accessToken: string, */ authorization, grantType, code, redirectUri, codeVerifier, refreshToken, scope, clientId, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        getKeys: (/* accessToken: string */ options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        getOidcSpec: (/* accessToken: string,  */ options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        introspectToken: (/* accessToken: string, */ authorization, token, clientId, options = {}) => __awaiter(this, void 0, void 0, function* () {
         ...
         * @throws {RequiredError}
         */
        logout: (/* accessToken: string, */ postLogoutRedirectUri, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        revoke: (/* accessToken: string,  */ token, authorization, tokenTypeHint, clientId, options = {}) => __awaiter(this, void 0, void 0, function* () {
