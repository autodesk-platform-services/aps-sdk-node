 ...
 * 
 * @export
 * @interface FolderContentsIncludedRelationshipsDownloadFormats
 */
export interface FolderContentsIncludedRelationshipsDownloadFormats {
    /**
     * 
     * @type {FolderContentsIncludedRelationshipsDownloadFormatsLinks}
     * @memberof FolderContentsIncludedRelationshipsDownloadFormats
     */
