...
export const CommandsApiAxiosParamCreator = function (apsConfiguration?: IApsConfiguration) {
    return {
         ...
         * @param {Command} [command] The request body\&#39;s &#x60;&#x60;data&#x60;&#x60; object defines the command to execute and contains any required input data.
         * @param accessToken bearer access token
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        executeCommand: async (accessToken: string, projectId: string, xUserId?: string, command?: Command,  options: ApsServiceRequestConfig = {}): Promise<RequestArgs> => {
            ...
            localVarRequestOptions.data = serializeDataIfNeeded(command, localVarRequestOptions, apsConfiguration)
...
export const CommandsApiFp = function(sdkManager?: SdkManager) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async executeCommand(accessToken: string, projectId: string, xUserId?: string, command?: Command, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Command>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.executeCommand(accessToken, projectId, xUserId, command,  options);
...
export interface CommandsApiInterface {
     ...
     */
    executeCommand(accessToken: string,projectId: string, xUserId?: string, command?: Command,  options?: ApsServiceRequestConfig): Promise<ApiResponse>;
...
export class CommandsApi extends BaseApi implements CommandsApiInterface {
     ...
     */
    public async executeCommand(accessToken: string, projectId: string, xUserId?: string, command?: Command, options?: ApsServiceRequestConfig) {
      this.logger.logInfo("Entered into executeCommand ");
      try {
        const request =  await CommandsApiFp(this.sdkManager).executeCommand(accessToken, projectId, xUserId, command,  options);
