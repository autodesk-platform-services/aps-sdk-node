 ...
 * @export
 * @interface ListItemsCommandAttributesExtensionData
 */
export interface ListItemsCommandAttributesExtensionData {
    /**
     ...
     * @type {boolean}
     * @memberof ListItemsCommandAttributesExtensionData
     */
