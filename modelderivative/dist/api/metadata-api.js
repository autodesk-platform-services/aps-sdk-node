...
const MetadataApiAxiosParamCreator = function (apsConfiguration) {
    return {
         ...
         */
        getUrnMetadata: (accessToken, urn, acceptEncoding, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'urn' is not null or undefined
            (0, common_1.assertParamExists)('getUrnMetadata', 'urn', urn);
         ...
         * @throws {RequiredError}
         */
        getUrnMetadataModelGuid: (accessToken, urn, modelGuid, acceptEncoding, xAdsForce, xAdsDerivativeFormat, forceget, objectid, level, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'urn' is not null or undefined
            (0, common_1.assertParamExists)('getUrnMetadataModelGuid', 'urn', urn);
            // verify required parameter 'modelGuid' is not null or undefined
            (0, common_1.assertParamExists)('getUrnMetadataModelGuid', 'modelGuid', modelGuid);
         ...
         * @throws {RequiredError}
         */
        getUrnMetadataModelGuidProperties: (accessToken, urn, acceptEncoding, xAdsForce, xAdsDerivativeFormat, objectid, forceget, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'urn' is not null or undefined
            (0, common_1.assertParamExists)('getUrnMetadataModelGuidProperties', 'urn', urn);
         ...
         * @throws {RequiredError}
         */
        postUrnMetadataModelGuidPropertiesQuery: (accessToken, urn, contentType, acceptEncoding, specificPropertiesPayload, options = {}) => __awaiter(this, void 0, void 0, function* () {
            // verify required parameter 'urn' is not null or undefined
            (0, common_1.assertParamExists)('postUrnMetadataModelGuidPropertiesQuery', 'urn', urn);
            // verify required parameter 'contentType' is not null or undefined
            (0, common_1.assertParamExists)('postUrnMetadataModelGuidPropertiesQuery', 'contentType', contentType);
...
const MetadataApiFp = function (sdkManager) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getUrnMetadata(accessToken, urn, acceptEncoding, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getUrnMetadata(accessToken, urn, acceptEncoding, options);
         ...
         * @throws {RequiredError}
         */
        getUrnMetadataModelGuid(accessToken, urn, modelGuid, acceptEncoding, xAdsForce, xAdsDerivativeFormat, forceget, objectid, level, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getUrnMetadataModelGuid(accessToken, urn, modelGuid, acceptEncoding, xAdsForce, xAdsDerivativeFormat, forceget, objectid, level, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, sdkManager);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        getUrnMetadataModelGuidProperties(accessToken, urn, acceptEncoding, xAdsForce, xAdsDerivativeFormat, objectid, forceget, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.getUrnMetadataModelGuidProperties(accessToken, urn, acceptEncoding, xAdsForce, xAdsDerivativeFormat, objectid, forceget, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, sdkManager);
            });
        },
        /**
         ...
         * @throws {RequiredError}
         */
        postUrnMetadataModelGuidPropertiesQuery(accessToken, urn, contentType, acceptEncoding, specificPropertiesPayload, options) {
            return __awaiter(this, void 0, void 0, function* () {
                const localVarAxiosArgs = yield localVarAxiosParamCreator.postUrnMetadataModelGuidPropertiesQuery(accessToken, urn, contentType, acceptEncoding, specificPropertiesPayload, options);
                return (0, common_1.createRequestFunction)(localVarAxiosArgs, sdkManager);
            });
        },
    };
...
class MetadataApi extends base_1.BaseAPI {
    ...
    getUrnMetadata(accessToken, urn, acceptEncoding, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.MetadataApiFp)(this.sdkManager).getUrnMetadata(accessToken, urn, acceptEncoding, options);
                ...
                if (error.response) {
                    ...
                    throw new base_1.ModelDerivativeApiApiError(`getUrnMetadata Request failed with status : ${error.response.status} and error message: ${error.response.data.reason}`, error);
                }
                else if (error.request) {
                    this.logger.logError(`getUrnMetadata Request failed with no response received: ${error.request}`);
                    throw new base_1.ModelDerivativeApiApiError(`getUrnMetadata Request failed with no response received: ${error.request}`, error);
                }
                throw error;
            }
        });
    ...
    getUrnMetadataModelGuid(accessToken, urn, modelGuid, acceptEncoding, xAdsForce, xAdsDerivativeFormat, forceget, objectid, level, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.MetadataApiFp)(this.sdkManager).getUrnMetadataModelGuid(accessToken, urn, modelGuid, acceptEncoding, xAdsForce, xAdsDerivativeFormat, forceget, objectid, level, options);
                const response = yield request(this.axios);
                ...
                if (error.response) {
                    ...
                    throw new base_1.ModelDerivativeApiApiError(`getUrnMetadataModelGuid Request failed with status : ${error.response.status} and error message: ${error.response.data.reason}`, error);
                }
                else if (error.request) {
                    this.logger.logError(`getUrnMetadataModelGuid Request failed with no response received: ${error.request}`);
                    throw new base_1.ModelDerivativeApiApiError(`getUrnMetadataModelGuid Request failed with no response received: ${error.request}`, error);
                }
                throw error;
            }
        });
    ...
    getUrnMetadataModelGuidProperties(accessToken, urn, acceptEncoding, xAdsForce, xAdsDerivativeFormat, objectid, forceget, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.MetadataApiFp)(this.sdkManager).getUrnMetadataModelGuidProperties(accessToken, urn, acceptEncoding, xAdsForce, xAdsDerivativeFormat, objectid, forceget, options);
                const response = yield request(this.axios);
                ...
                if (error.response) {
                    ...
                    throw new base_1.ModelDerivativeApiApiError(`getUrnMetadataModelGuidProperties Request failed with status : ${error.response.status} and error message: ${error.response.data.reason}`, error);
                }
                else if (error.request) {
                    this.logger.logError(`getUrnMetadataModelGuidProperties Request failed with no response received: ${error.request}`);
                    throw new base_1.ModelDerivativeApiApiError(`getUrnMetadataModelGuidProperties Request failed with no response received: ${error.request}`, error);
                }
                throw error;
            }
        });
    ...
    postUrnMetadataModelGuidPropertiesQuery(accessToken, urn, contentType, acceptEncoding, specificPropertiesPayload, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield (0, exports.MetadataApiFp)(this.sdkManager).postUrnMetadataModelGuidPropertiesQuery(accessToken, urn, contentType, acceptEncoding, specificPropertiesPayload, options);
                const response = yield request(this.axios);
                ...
                if (error.response) {
                    ...
                    throw new base_1.ModelDerivativeApiApiError(`postUrnMetadataModelGuidPropertiesQuery Request failed with status : ${error.response.status} and error message: ${error.response.data.reason}`, error);
                }
                else if (error.request) {
                    this.logger.logError(`postUrnMetadataModelGuidPropertiesQuery Request failed with no response received: ${error.request}`);
                    throw new base_1.ModelDerivativeApiApiError(`postUrnMetadataModelGuidPropertiesQuery Request failed with no response received: ${error.request}`, error);
                }
                throw error;
            }
        });
