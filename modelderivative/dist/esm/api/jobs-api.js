...
export class JobsApi extends BaseAPI {
    ...
    postJob(accessToken, contentType, xAdsForce, xAdsDerivativeFormat, jobPayload, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield JobsApiFp(this.sdkManager).postJob(accessToken, contentType, xAdsForce, xAdsDerivativeFormat, jobPayload, options);
    ...
    postReferences(accessToken, urn, contentType, postReferencesRequest, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield JobsApiFp(this.sdkManager).postReferences(accessToken, urn, contentType, postReferencesRequest, options);
                const response = yield request(this.axios);
