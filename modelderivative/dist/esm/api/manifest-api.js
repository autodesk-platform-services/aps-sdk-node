...
export class ManifestApi extends BaseAPI {
    ...
    deleteUrnManifest(accessToken, urn, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield ManifestApiFp(this.sdkManager).deleteUrnManifest(accessToken, urn, options);
    ...
    getUrnManifest(accessToken, urn, acceptEncoding, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield ManifestApiFp(this.sdkManager).getUrnManifest(accessToken, urn, acceptEncoding, options);
                const response = yield request(this.axios);
