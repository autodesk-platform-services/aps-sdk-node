...
export class MetadataApi extends BaseAPI {
    ...
    getUrnMetadata(accessToken, urn, acceptEncoding, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield MetadataApiFp(this.sdkManager).getUrnMetadata(accessToken, urn, acceptEncoding, options);
    ...
    getUrnMetadataModelGuid(accessToken, urn, modelGuid, acceptEncoding, xAdsForce, xAdsDerivativeFormat, forceget, objectid, level, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield MetadataApiFp(this.sdkManager).getUrnMetadataModelGuid(accessToken, urn, modelGuid, acceptEncoding, xAdsForce, xAdsDerivativeFormat, forceget, objectid, level, options);
                const response = yield request(this.axios);
    ...
    getUrnMetadataModelGuidProperties(accessToken, urn, acceptEncoding, xAdsForce, xAdsDerivativeFormat, objectid, forceget, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield MetadataApiFp(this.sdkManager).getUrnMetadataModelGuidProperties(accessToken, urn, acceptEncoding, xAdsForce, xAdsDerivativeFormat, objectid, forceget, options);
                const response = yield request(this.axios);
    ...
    postUrnMetadataModelGuidPropertiesQuery(accessToken, urn, contentType, acceptEncoding, specificPropertiesPayload, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield MetadataApiFp(this.sdkManager).postUrnMetadataModelGuidPropertiesQuery(accessToken, urn, contentType, acceptEncoding, specificPropertiesPayload, options);
                const response = yield request(this.axios);
