...
export declare const JobSvfOutputFormatAdvanced_2dviewsEnum: {
...
export declare const JobSvfOutputFormatAdvancedConversionMethodEnum: {
    readonly Legacy: "legacy";
...
export declare const JobSvfOutputFormatAdvancedBuildingStoreysEnum: {
    readonly Hide: "hide";
    readonly Show: "show";
    readonly Skip: "skip";
};
...
export declare const JobSvfOutputFormatAdvancedSpacesEnum: {
    readonly Hide: "hide";
    readonly Show: "show";
    readonly Skip: "skip";
};
...
export declare const JobSvfOutputFormatAdvancedOpeningElementsEnum: {
    readonly Hide: "hide";
    readonly Show: "show";
    readonly Skip: "skip";
};
...
export declare const JobSvfOutputFormatAdvancedExtractorVersionEnum: {
    readonly Next: "next";
...
export declare const JobSvfOutputFormatAdvancedMaterialModeEnum: {
    readonly Auto: "auto";
...
export declare const JobSvfOutputFormatAdvancedHierarchyEnum: {
