...
export const MetadataApiAxiosParamCreator = function (apsConfiguration?: IApsConfiguration) {
    return {
         ...
         */
        fetchSpecificProperties: async (accessToken: string, urn: string, modelGuid: string, acceptEncoding?: string, region?: Region, xAdsDerivativeFormat?: XAdsDerivativeFormat, specificPropertiesPayload?: SpecificPropertiesPayload,  options: ApsServiceRequestConfig = {}): Promise<RequestArgs> => {
...
export const MetadataApiFp = function(sdkManager?: SdkManager) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async fetchSpecificProperties(accessToken: string, urn: string, modelGuid: string, acceptEncoding?: string, region?: Region, xAdsDerivativeFormat?: XAdsDerivativeFormat, specificPropertiesPayload?: SpecificPropertiesPayload, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<SpecificProperties>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.fetchSpecificProperties(accessToken, urn, modelGuid, acceptEncoding, region, xAdsDerivativeFormat, specificPropertiesPayload,  options);
         ...
         * @throws {RequiredError}
         */
        async getAllProperties(accessToken: string, urn: string, modelGuid: string, acceptEncoding?: string, xAdsForce?: boolean, xAdsDerivativeFormat?: XAdsDerivativeFormat, region?: Region, objectid?: number, forceget?: string, options?: ApsServiceRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<Properties>> {
...
export class MetadataApi extends BaseApi implements MetadataApiInterface {
     ...
     */
    public async fetchSpecificProperties(accessToken: string, urn: string, modelGuid: string, acceptEncoding?: string, region?: Region, xAdsDerivativeFormat?: XAdsDerivativeFormat, specificPropertiesPayload?: SpecificPropertiesPayload, options?: ApsServiceRequestConfig) {
      this.logger.logInfo("Entered into fetchSpecificProperties ");
      try {
        const request =  await MetadataApiFp(this.sdkManager).fetchSpecificProperties(accessToken, urn, modelGuid, acceptEncoding, region, xAdsDerivativeFormat, specificPropertiesPayload,  options);
