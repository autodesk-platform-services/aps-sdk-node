...
export class ModelDerivativeClient extends BaseClient {
    ...
    * 
    * @param {XAdsDerivativeFormat} [optionalArgs.xAdsDerivativeFormat] Specifies what Object IDs to return, if the design has legacy SVF derivatives generated by the BIM Docs or Forma Data Management service. Possible values are:  
    * 
