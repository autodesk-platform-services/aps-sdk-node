...
async function createBucket(){
    const policyKey:CreateBucketsPayloadPolicyKeyEnum="<policyKey>";
    const xAdsRegion:CreateBucketXAdsRegionEnum="<Emea>"
    const response = await ossClient.createBucket(access_token, xAdsRegion,{bucketkey,policyKey});
    console.log(response);
}
