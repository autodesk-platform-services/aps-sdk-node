...
export class HooksApi extends BaseAPI {
    ...
    deleteSystemsSystemEventsEventHooksHookId(accessToken, system, event, hookId, xAdsRegion, region, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield HooksApiFp(this.sdkManager).deleteSystemsSystemEventsEventHooksHookId(accessToken, system, event, hookId, xAdsRegion, region, options);
    ...
    getSystemsSystemEventsEventHooks(accessToken, system, event, xAdsRegion, region, scopeName, pageState, status, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield HooksApiFp(this.sdkManager).getSystemsSystemEventsEventHooks(accessToken, system, event, xAdsRegion, region, scopeName, pageState, status, options);
                const response = yield request(this.axios);
    ...
    getSystemsSystemEventsEventHooksHookId(accessToken, system, event, hookId, xAdsRegion, region, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield HooksApiFp(this.sdkManager).getSystemsSystemEventsEventHooksHookId(accessToken, system, event, hookId, xAdsRegion, region, options);
                const response = yield request(this.axios);
    ...
    getSystemsSystemHooks(accessToken, system, xAdsRegion, status, pageState, region, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield HooksApiFp(this.sdkManager).getSystemsSystemHooks(accessToken, system, xAdsRegion, status, pageState, region, options);
                const response = yield request(this.axios);
    ...
    patchSystemsSystemEventsEventHooksHookId(accessToken, system, event, hookId, xAdsRegion, region, updateHook, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield HooksApiFp(this.sdkManager).patchSystemsSystemEventsEventHooksHookId(accessToken, system, event, hookId, xAdsRegion, region, updateHook, options);
                const response = yield request(this.axios);
    ...
    postSystemsSystemEventsEventHooks(accessToken, system, event, xAdsRegion, region, createHook, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield HooksApiFp(this.sdkManager).postSystemsSystemEventsEventHooks(accessToken, system, event, xAdsRegion, region, createHook, options);
                const response = yield request(this.axios);
    ...
    postSystemsSystemHooks(accessToken, system, xAdsRegion, region, createHook, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const request = yield HooksApiFp(this.sdkManager).postSystemsSystemHooks(accessToken, system, xAdsRegion, region, createHook, options);
                const response = yield request(this.axios);
